...
export const GET: RequestHandler = async () => {
    const branch: Branch = await octokit.request('https://api.github.com/repos/bevyengine/bevy/branches/main').then(res => res.data);
    ...
    const examples_tree: Tree = await octokit.request(examples_tree_url + "?recursive=1").then(res => res.data);
